...
class FichasController extends Controller
{
    ...
    public function index02(){ 
        ...
        array_push($totalesEmpresa,[
            ...
            // dd($ArrayZonas);
        return view('forms.fichas.listar.lstTicketsAsignados',[ 
   ...
   public function FichasPorZona($id){ 
    //    dd('llego');
        ...
        return view('forms.fichas.ticketsZona.lstTicketsZona',[  
   ...
   public function FichasPorTrabajador($id){ 
    //    dd('llego');
        ...
        return view('forms.fichas.ticketsTrabajador.lstTicketsTrabajador',[  
            'arrayTabla'             =>$datosTabla,
    ...
    public function ayuda(){
        ...
        foreach ($router as $rou) {
                if ($API->connect($rou->ip , $rou->usuario , $rou->password, $rou->puerto )) {  
                          ...
                          $ARRAY_PROFILES = $API->comm("/ip/hotspot/host/remove");  
