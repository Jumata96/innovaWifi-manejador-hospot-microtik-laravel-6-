<head>
    <meta charset="UTF-8">
    <title> {{ (empty(Auth::user()->titulo))? 'InnovaWifi' : Auth::user()->titulo }} - @yield('titulo', 'Inicio') </title>
    ...
    <link href="{{asset('css/vue-multiselect.min.css')}}" type="text/css" rel="stylesheet">  
