  ...
  <header id="header" class="page-topbar">
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color teal darken-1">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li>
                        <h1 class="logo-wrapper">
                          <a href="{{ url('/home') }}" class="brand-logo darken-1">
                            <h4 class="center" style="color: #ffb300; font-style: italic; margin-top: 13px"><b style="color: #fafafa; font-style: normal;">INNOVA</b>Mk</h4>
                          </a> 
