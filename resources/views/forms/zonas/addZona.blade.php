...
@section('titulo','Registrar Punto de Venta')
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                              <div class="input-field col s12 m6 l6 ">
                                ...
                                <input id="codigo" name="codigo" type="text"   maxlength="3" onkeyup="mayus(this);">
                              ...
                              <div class="input-field col s12 m6 l6">
                                ...
                                <input id="color" name="color" type="text" readonly="readonly">
...
@section('script')
	@include('forms.zonas.scripts.addZona')
  @include('forms.zonas.modalColores')
	@include('forms.zonas.scripts.modalColores')
