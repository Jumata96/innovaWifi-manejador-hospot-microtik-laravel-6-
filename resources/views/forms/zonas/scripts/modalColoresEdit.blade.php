  ...
  <div class="modal-content" >
	 <div id="dynamic-color" class="section">
		<div class="row" id="items_en_uso">
		  <div class="dynamic-color" id="color"> 
			 <div  {{-- style="position: fixed;" --}} class="col s12 m12 l12">

				<div class="  row card-header sub-header">
							  

							 <center><h4 class="header">Paleta de Colores </h4></center>

							 <a id="guardar" class="btn-floating right waves-effect waves-light grey lighten-5 tooltipped" href="#!" data-activates="dropdown2" data-position="top" data-delay="200" data-tooltip="guardar" style="width: 40px;height: 39px;padding-right: 0px;padding-left: 0px;">
								<center><i  class="material-icons blue-text text-darken-2">check</i></center></a> 
						 <a id="cancelar" class="btn-floating left waves-effect waves-light grey lighten-5 tooltipped" href="#!" data-activates="dropdown2" data-position="top" data-delay="500" data-tooltip="Regresar" style="position: fixed;width: 40px;height: 39px;padding-right: 0px;padding-left: 0px;">
						<center><i class="material-icons" style="color: #424242">keyboard_tab</i></center></a>  

				</div> 
				<div class="col s12 m6 l2 " id="colorSeleccionado" ></div>
				 <div class="  col s12 m6 l6">
				  <i id="iconColor1" class="material-icons prefix" >color_lens</i>
				  <label for="color1">Color 1</label>
				  <input id="color1" name="color1" type="text" readonly="readonly">
			 ...
			 <div class="col s12 m6 l4">
				...
				<div class="red" id="f44336">#f44336 red</div>
