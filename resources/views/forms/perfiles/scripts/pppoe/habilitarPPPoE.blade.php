<script type="text/javascript">
	 //----JPaiva-22-06-2018------------------HABILITAR---------------------------
    @foreach ($pppoe as $val)
        $('#pa{{$val->idperfil}}').click(function(e){
          e.preventDefault();
          ...
          $.ajax({
              ...
              if ( data[0] == "error") {
                ...
                "</td>"+
                "<td class='center'>"+
                  "<a href='#updPPPoE' id='upd"+obj[0]['idperfil']+"' class='btn-floating waves-effect waves-light grey lighten-5 tooltipped' data-position='top' data-delay='500' data-tooltip='Ver'><i class='mdi-action-visibility' style='color: #7986cb'></i></a>"+                                     
