					...
					<table id="data-table-simple" class="responsive-table display tabla" cellspacing="0">
						...
						<tbody>
							...
							<tr id="htr{{$valor->idperfil}}">
								...
								<td>
													<a style="background-color: #{{$valor->perfil_color}};" class="btn-floating btn-small waves-effect waves-light  ">
								...
								<td class="center" style="width: 9rem">
									<a href="#updHotspot" id="updHotspot{{$valor->idperfil}}" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped modal-trigger" data-position="top" data-delay="500" data-tooltip="Ver" data-id="{{$valor->idperfil}}" data-idrouter="{{$valor->idrouter}}" data-name="{{$valor->name}}" data-vbajada="{{$valor->vbajada}}" data-autoeliminado="{{$valor->perfil_autoeliminado}}"  data-color="{{$valor->perfil_color}}" data-precio="{{$valor->precio}}" 		data-dias="{{$valor->perfil_sesion_dias}}" 	data-horas="{{$valor->perfil_sesion_horas}}"	data-minutos="{{$valor->perfil_sesion_min}}"

										data-vsubida="{{$valor->vsubida}}" data-glosa="{{$valor->glosa}}" data-idrouter="{{$valor->idrouter}}" data-estado="{{$valor->estado}}" data-dsc_perfil="{{$valor->dsc_perfil}}" data-perfil="{{$valor->hotspot_perfil}}">
...
@include('forms.tickets.modalColores')
@include('forms.tickets.modalColores_upd')
@include('forms.tickets.scripts.modalColores')
{{-- @include('forms.tickets.scripts.modalColores_upd') --}}
...
@include('forms.perfiles.scripts.hotspot.focusTimeConection')
