...
<head>
  ...
  <title>Formatter | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-editor-insert-comment"></i> Forms <span class="new badge"></span></a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="form-masks.html">Form Masks</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Formatter</h5>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption"><a href="https://github.com/firstopinion/formatter.js" target="_blank">Formatter</a> Format user input to match a specified pattern.</p>
          <div class="divider"></div>
          <!--formatter-->
          <div id="formatter" class="section">
            <div class="row">
                    ...
                    <form class="col s12">
                     <div class="row">
                        <div class="input-field col s6">
                          <input placeholder="2015-01-01" id="date-demo1" type="text" class="">
                          <label for="date_demo1">Date</label>
                        </div>
                        <div class="input-field col s6">
                          <input placeholder="01/01/2015" id="date-demo2" type="text" class="">
                          <label for="date_demo2">Date</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s6">
                          <input placeholder="00:00" id="time-demo" type="text" class="">
                          <label for="time_demo">Time</label>
                        </div>
                        <div class="input-field col s6">
                          <input placeholder="01/01/2015 00:00" id="date-time" type="text" class="">
                      ...
                      <div class="row">
                        ...
                        <div class="input-field col s6">
                          ...
                          <label for="first_name">Credit Input</label>
                        </div>
                      </div>
                    </form>
                  ...
                  <form class="col s12">
                     <div class="row">
                        <div class="input-field col s6">
                          ...
                          <label for="phone_demo">Phone</label>
                        </div>
                        <div class="input-field col s6">
