...
<div id="modal1" class="modal modal-fixed-footer" style="height: 100%; overflow: hidden;">
...
<div class="row card-header sub-header" style="margin-top: 3.15rem; margin-left: 0rem; margin-right: 0rem; position: fixed; width: 100%; z-index: 3">
	<div class="col s12 m12 herramienta">     
		...
		<button id="guardar" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" type="submit" name="action" data-position="top" data-delay="500" data-tooltip="Guardar">
				...
				<div class="card white">
							<div class="row">
								<center><h4 class="header">Color Seleccionado</h4></center>
										<div class=" col s12 m6 l6 offset-l3  " id="divColor1 " name="color1"> 
