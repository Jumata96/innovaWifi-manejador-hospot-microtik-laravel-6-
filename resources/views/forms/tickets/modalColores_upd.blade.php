...
<div id="modal_colores_upd" class="modal modal-fixed-footer" style="height: 100%; overflow: hidden;">
...
<div class="row card-header sub-header" style="margin-top: 3.15rem; margin-left: 0rem; margin-right: 0rem; position: fixed; width: 100%; z-index: 3">
	<div class="col s12 m12 herramienta">     
		...
		<button id="guardar_colores_upd" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" type="submit" name="action" data-position="top" data-delay="500" data-tooltip="Guardar">
...
<form style="margin-top: 70px">
	<div class="row cuerpo" style="margin-left: 0.5rem; margin-right: 0.5rem; padding-top:55px; z-index: 1">
				...
				<div class="card white">
							<div class="row">
								<center><h4 class="header">Color Seleccionado</h4></center>
										<div class=" col s12 m6 l6 offset-l3  " id="divColor1_upd " name="color_selc_upd"> 
													<i  id="iconColor1_upd" class="material-icons prefix">color_lens</i>
													<label for="color_selc_upd">Color</label>
													<input id="color_selc_upd" name="color_selc_upd" type="text" readonly="readonly">
										</div>
							</div>
				</div>

	<div class="card white">
		<div class="card-content dynamic-color" id="color"> 
