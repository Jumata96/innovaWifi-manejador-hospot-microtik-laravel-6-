		...
		<form  id="myForm" accept-charset="UTF-8" enctype="multipart/form-data">
			<div class="row card-header sub-header">
				<div class="col s12 m12 herramienta">                         
					...
					<a href="{{ url('fichasPuntoVenta_vendidas') }}/{{$Trabajador['ZonaId']}}" class="btn-floating right waves-effect waves-light grey lighten-5 tooltipped" href="#!" data-activates="dropdown2" data-position="top" data-delay="500" data-tooltip="Regresar">
					<i class="material-icons" style="color: #424242">keyboard_tab</i></a>   
					<a style="margin: 6px;padding: 8px"></a>   
						...
						<div class="card-content">
							...
							<div class="input-field col s12 m4 l3"> 
										...
										<div class="input-field col s12 m12 l12">
												...
												<input value="{{$Trabajador['TrabajadorNombre']}}" name="Trabajadores" type="text"  class="Trabajadores" readonly="readonly" >
												...
												<tbody>
													<tr>
														...
														<td>
																...
																<a  target="_bank"  href="{{url('/imprimir/fichaTrabajador')}}/{{$datos['perfilAsignado']}}"   class="btn-floating waves-effect waves-light grey lighten-5 tooltipped " data-position="top" data-delay="500" data-tooltip="Descargar PDF"    >
