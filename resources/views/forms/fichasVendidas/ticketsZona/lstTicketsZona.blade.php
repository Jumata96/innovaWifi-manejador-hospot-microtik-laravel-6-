              ...
              <th> </th>
												...
												<tbody>
													<tr>
														...
														<td>$ {{$datos['saldoD']}}</td>
														<td>
																<a href="{{ url('fichasZonaTrabajador_vendidas') }}/{{$datos['id']}}"  target="_bank"  id="updHotspot{{$datos['id']}}" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped modal-trigger" data-position="top" data-delay="500" data-tooltip="Ver" data-id="{{$datos['id']}}"  >
