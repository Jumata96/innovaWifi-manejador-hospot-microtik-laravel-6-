	...
	<div class="row cuerpo" style="margin-left: 0.5rem; margin-right: 0.5rem; padding-top:55px; z-index: 1; margin-top: 70px">
		<div class="card white col s12 m12 l12" >
			<form  id="myFormModal" accept-charset="UTF-8" enctype="multipart/form-data">
                ...
                <option value="{{$vendedorList->id}}"> {{$vendedorList->nombre}} {{$vendedorList->apellidos}}</option> 
                @endforeach 
						</select>
		...
		<div class="card white col s12 m12 l12" id="historial_perfiles_asignados" style="display: none;"> 
				<div class="card-content">     
											<table id="data-table-simpleI" class="responsive-table display" cellspacing="0">
												...
												<tfoot>
													<tr>
														<th ></th>#</th>
														<th id="totalRegistros">#</th>
														<th></th> 
														<th id="totalAsignados">T.asignados</th>
														<th id="totalVendidos">T.vendidos</th>
														<th id="totalSaldo">T.saldo</th> 
													</tr>
												</tfoot>
														<tr> 
															<td></td>
