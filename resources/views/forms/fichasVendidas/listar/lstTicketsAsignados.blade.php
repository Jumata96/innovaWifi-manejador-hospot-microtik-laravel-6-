										  ...
										  <tbody>
											...
											?>
													...
													<tr> 
														...
														<td> $ {{$datos['tSaldo']}}</td>  
														<td> 
															 <a href="{{ url('fichasPuntoVenta_vendidas') }}/{{$datos['id']}}"  class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Ver">
