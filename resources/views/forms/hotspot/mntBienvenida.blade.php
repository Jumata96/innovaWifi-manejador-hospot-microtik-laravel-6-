...
<div class="row">
  <div class="col s12 m7 l7">
                 ...
                 <form class="formValidate right-alert" id="myForm" method="POST" action="{{ url('/vision/grabar') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                  <div class="card-header" style="height: 50px; padding-top: 5px; background-color: #f6f6f6">
                        <div class="col s12 m12">
                          <a id="addBienvenida" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" name="action" data-position="top" data-delay="500" data-tooltip="Guardar">
                            <i class="material-icons" style="color: #2E7D32">check</i>
                          </a>   
                          <a href="{{ url('/hotspot/pagina-bienvenida') }}" target="_blank" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Ver prototipo página">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                              ...
                              <div class="col s12">
                                ...
                                <div class="col s12 m6 l4">
                                  <label for="color" class="active">Definir Color</label>
                                  <input id="color_btn_navegar" name="color_btn_navegar" type="text" value="{{$datos->color_btn_navegar}}" data-error=".errorTxt2" maxlength="100">                                    
                                </div>
                                <div class="input-field col s12 m6 l8">                                  
                                  <p>Definir color de fondo para el botón de cerrar sesión.</p>
                                </div>
                                <div class="col s12 m6 l4">
                                  <label for="color" class="active">Definir Color</label>
                                  <input id="color_btn_cerrar" name="color_btn_cerrar" type="text" value="{{$datos->color_btn_cerrar}}" data-error=".errorTxt2" maxlength="100">                                    
                                </div>
                                <div class="input-field col s12 m6 l8">                                  
                                  <p>Ingrese el link que desea redireccionar al hacer click en el botón navegar en internet. </p>
                                </div>
                                <div class="col s12 m6 l4">
                                  <label for="color" class="active">Ingresar Link</label>
                                  <input id="COLOR_FONDO_PROD" name="link" type="text" value="{{$datos->link}}" data-error=".errorTxt2">                                    
                                </div>
                              </div>
              ...
              <a href="{{url('hotspot/pagina-bienvenida')}}" target="_blank" class="btn waves-effect waves-light gradient-45deg-indigo-blue col s12" style="height: 44px; letter-spacing: .5px; padding-top: 0.3rem"><b>VER PROTOTIPO DE LA PÁGINA</b>
                     ...
                     <div class="card white">
                      ...
                      <div class="card white">
                          <div class="card-content" style="padding-top: 4px">
                            <div class="row" style="padding-top: 20px">
                              <div class="col s6 m8 l10">
                                <p style="padding: 0px">Mostrar status refresh</p>

                              </div>
                              <div class="col s6 m4 l2">
                                <div class="switch secondary-content">                     
                                  <label>                              
                                    @if($datos->mostrar_status == 1)                                                                          
                                    <input type="checkbox" id="mostrar_status" name="mostrar_status" checked="">
                                    @else
                                    <input type="checkbox" id="mostrar_status" name="mostrar_status">
                                    @endif
                                    <span class="lever"></span> 
                                  </label>
                                </div>
...
@section('script')
  @include('forms.hotspot.scripts.addBienvenida')
  @include('forms.hotspot.scripts.addParametrosBienvenida')
@endsection
